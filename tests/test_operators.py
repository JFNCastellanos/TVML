...
class TestOperators():
    def __init__(self,nv,nx,nt,blocks_x,blocks_t):
        ...
        self.P = torch.zeros(self.n,self.nv*self.na,dtype=complex)
        self.Pdagg = torch.zeros(self.nv*self.na,self.n,dtype=complex)
    
    def flatten_col(self,col):
        flat = torch.zeros(self.n,dtype=complex)
    ...
    def flatten_colV2(self,col):
        flat = torch.zeros(self.nv*self.na,dtype=complex)
